...
# 2. Посчитать, сколько раз встречается определенная цифра(цифра – это от 0 до 9) в списке чисел. Количество введенных чисел в список и искомая цифра задаются с клавиатуры. Числа выбираются рандомно.
# import random
# c_ran = int(input(" Cколько завести случайных чисел: "))
# ran_spis= [random.randint(0,100) for i in  range(c_ran)]
# print("Введенный список:", ran_spis)
# q = "".join(map(str,ran_spis))
# find = input('введите число')
#
# print(q.count(find))
...
print('3 задание')
text = input()
all_gl = 'аАеЕёЁиИоОуУыЫэЭюЮяЯaAeEuUiIoO'
c_cogl = 0
c_gl = 0
pair_lower = 0
pair_upper = 0
...
print('Всего' , len(text) , 'букв в слове')
print('всего гласных', c_gl, ' согласных', c_cogl)
